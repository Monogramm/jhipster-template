package com.monogramm.jhipster.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.monogramm.jhipster.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.monogramm.jhipster.repository.UserRepository.USERS_BY_EMAIL_CACHE);
