    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">template</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/parameter">
                        ...
                        <span v-text="$t('global.menu.entities.parameter')">Parameter</span>
                    </b-dropdown-item>
