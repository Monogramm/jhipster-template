...
export default class ParameterComponentsPage extends AlertPage {
...
export class ParameterDeleteDialog {
  ...
  title: ElementFinder = element(by.id('templateApp.parameter.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-parameter'));
}
